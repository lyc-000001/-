...
def base_page():
    with sync_playwright() as playwright:
        ...
        context = browser.new_context(record_video_dir=Config.test_videos_dir, no_viewport=True,
                                      viewport={"width": 375, "height": 812},  # 设置视口大小，模拟手机屏幕
                                      user_agent="Mozilla/5.0 (iPhone; CPU iPhone OS 13_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/78.0.3904.97 Mobile/15E148 Safari/604.1")
        # 录制日志
